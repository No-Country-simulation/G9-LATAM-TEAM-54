...
const emit = defineEmits(["generar-reporte", "logout"])
    ...
    <div class="flex items-center space-x-3">
      ...
      <div>
        <div class="flex items-center space-x-2">
          <span class="text-[10px] font-extrabold uppercase tracking-widest text-slate-400">EnergiAI</span>
        ...
        <div class="flex items-center space-x-1.5 mt-0.5">
          ...
          <span class="text-[10px] text-emerald-400/90 font-medium">{{ tabMeta.badge }}</span>
        </div>
      </div>
    </div>
